...
from .const import WS_CMD_COVER_CLOSE, WS_CMD_COVER_OPEN, WS_CMD_SET_POS
...
class GdoDevice(RyobiWssCtrl):
    ...
    def current_state(self):
        ...
        if "doorState" in self.garage_state:
            self.garage_state["doorState"]["state"] = self.garage_state["doorState"][
                "enum"
            ][self.garage_state["doorState"]["value"]]
    ...
    def is_available(self):
        ...
        if "is_available" in self.garage_state:
            return self.garage_state[
                "is_available"
            ]  # TODO not properly implemented to check
